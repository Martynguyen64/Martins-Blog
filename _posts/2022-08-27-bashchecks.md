---
keywords: fastai
description: Proof of all the neccesarry key tools for APCSP
title: Marty's Bash Tool Check
toc: true 
badges: true
comments: true
categories: [Bash]
nb_path: _notebooks/2022-08-27-bashchecks.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-08-27-bashchecks.ipynb
-->
...
<div class="output_subarea output_stream output_stdout output_text">
<pre># packages in environment at /home/martinnguyen64/anaconda3:
#
...
traitlets        : 5.1.1
Available kernels:
  bash          /home/martinnguyen64/.local/share/jupyter/kernels/bash
  javascript    /home/martinnguyen64/.local/share/jupyter/kernels/javascript
  python3       /home/martinnguyen64/anaconda3/share/jupyter/kernels/python3
</pre>
</div>
</div>
...
<p>Hack Questions:</p>
<ol>
<li><p>We can use --version to make sure we have our things installed properly and ensure they are up to date.</p>
</li>
<li><p>We can verify all packages and versions are installed by using the command conda list</p>
</li>
<li><p>We use git add command to add needed files, we use git commit to commit to the correct repository, and we use git push to push changes to repository.</p>
</li>
<li><p>We can automate an action by programming the script in order to complete a task we want to get done.</p>
</li>
</ol>
