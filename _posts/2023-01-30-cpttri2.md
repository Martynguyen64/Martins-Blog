...
The SQL will be the database that will save the users input under their account.
CSS will be utilized to design the page/
Javascript and Python will make a successful api with the functions to fetch the users input and connect the database
## Video Ideation
